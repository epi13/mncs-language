//! Conservative explicit-argv process effect for native application adapters.
//!
//! This is a generic host capability, not an application policy engine.  It
//! never invokes a shell, bounds all caller-controlled collections and output,
//! and kills a child when its wall-clock deadline expires.
