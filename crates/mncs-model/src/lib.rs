...
pub use compiler::{
    ...
    BACKEND_ARTIFACT_SCHEMA_VERSION_PRE_INTERFACE, BACKEND_ARTIFACT_SCHEMA_VERSION_PRE_TYPED,
    BACKEND_CAPABILITY_SCHEMA_VERSION, COMPILATION_STUDY_OBSERVATION_INTERPRETATION,
    COMPILATION_STUDY_RESULT_CONTRACT_ID, COMPILER_ARTIFACT_SCHEMA_VERSION,
    FAMILY_COMPILER_REFERENCE_SCHEMA_VERSION, LAYERED_EXECUTION_COMPARISON_INTERPRETATION,
...
pub use execution::{
    ...
    ObservationCompletenessStatus, ObservedExecutionResult, ProviderCall, ProviderRuntime,
